...
public class ZoomMyMeetingActivity extends MeetingActivity {
    ...
    protected int getLayout() {
        return R.layout.zoom_my_meeting_layout;
    }
    ...
    private void setupTabs() {
        ...
        selectTab(ZoomMainActivity.TAB_MEETING);
        ...
        btnTabWelcome.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                selectTab(ZoomMainActivity.TAB_WELCOME);
            }
        });

        btnTabPage2.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                selectTab(ZoomMainActivity.TAB_PAGE_2);
            }
        });
    }

    private void selectTab(int tabId) {
        if (tabId == ZoomMainActivity.TAB_MEETING) {
    ...
    private void switchToMainActivity(int tab) {
        Intent intent = new Intent(this, ZoomMainActivity.class);
        intent.setAction(ZoomMainActivity.ACTION_RETURN_FROM_MEETING);
        intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
        intent.putExtra(ZoomMainActivity.EXTRA_TAB_ID, tab);

...
import us.zoom.sdkexample2.R;

public class ZoomMainActivity extends Activity implements ZoomConstants, MeetingServiceListener, ZoomSDKInitializeListener {
    ...
    private static String DISPLAY_NAME = "Zoom";
  ...
  /*  private View viewTabWelcome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zoom_my_main_layout);
        ...
        joinBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (id.isEmpty()) {
                    ...
                    Toast.makeText(ZoomMainActivity.this, "Meeting id needed", Toast.LENGTH_SHORT).show();
                    Log.i("Zoom", "Meeting id is needed");
                    return;
                }
                ...
                if (!zoomSDK.isInitialized()) {
                    ...
                    Log.i("Zoom", "ZoomSDK has not been initialized successfully");
                    return;
                }
                ...
                /*    viewTabWelcome.setVisibility(View.GONE);
                    ...
                    meetingService.returnToMeeting(ZoomMainActivity.this);
                }
...
*/
    ...
    public void onZoomSDKInitializeResult(int errorCode, int internalErrorCode) {
        ...
        if (errorCode != ZoomError.ZOOM_ERROR_SUCCESS) {
            ...
            Log.i("Zoom", "Failed to initialize Zoom SDK. Error: " + errorCode + " , internalErrorCode= " + internalErrorCode);
        } else {
            Toast.makeText(this, "Initialize Zoom SDK successfully.", Toast.LENGTH_LONG).show();
            Log.i("Zoom", "Initialize Zoom SDK successfully");
            registerMeetingServiceListener();
        }
    }
    ...
    public void startMeeting() {
        ...
        if (id == null) {
            ...
            Log.i("Zoom", "MEETING_ID in Constants can not be NULL");
            return;
        }
